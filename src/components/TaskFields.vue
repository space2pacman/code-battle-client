<template>
	<div class="mt-3">
		<input type="text" class="form-control mb-3" placeholder="Название задачи" v-model="data.caption">
		<textarea class="form-control mb-3" placeholder="Описание задачи" v-model="data.description"></textarea>
